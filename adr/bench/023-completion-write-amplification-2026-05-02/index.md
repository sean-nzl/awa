...
This note records a focused completion-path follow-up to [ADR-023](../../023-receipt-plane-ring-partitioning/index.md). The experiment targeted three costs visible in the portable harness:
